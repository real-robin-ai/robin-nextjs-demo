...
const colors = {
  ...
  lime: 'bg-lime-400/40 text-lime-700 group-data-hover:bg-lime-400/50 dark:bg-lime-400/20 dark:text-lime-300 dark:group-data-hover:bg-lime-400/30 border border-lime-400',
  green:
